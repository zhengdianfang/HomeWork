 ...
 */
public class HomeworkSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
     ...
     * @param context
     */
    public HomeworkSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public HomeworkSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            修改进度圈的X坐标使之位于左边
        mCircleView.layout(childLeft + 32, mCurrentTargetOffsetTop,
                childLeft+circleWidth + 32, mCurrentTargetOffsetTop + circleHeight);
    }
